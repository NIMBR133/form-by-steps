...
`,U=c.div`
  grid-column: span 2;
`,X={Fields:K,DateAndGender:Q,InputFullWidth:U},{Option:Y}=I,ee=()=>{const[e,h]=i.useState([]),o=async s=>{const r=await B.searchCitiesByRegion(s);h(r.data.suggestions)};return t(H,{name:"city",placeholder:"Санкт-Петербург",label:"Основной город*",required:n.required,onSearch:o,children:e.map(s=>t(Y,{value:s.data.city_with_type,children:s.data.city_with_type},s.data.city_fias_id))})},{Fields:te,DateAndGender:re,InputFullWidth:ae}=X,oe=()=>{const{step_1:e}=b(w),h=f(),o=F({defaultValues:e||void 0}),s=r=>{h(y(r))};return t(q,{icon:t(L,{}),title:"Общие",text:"Введите свои персональные данные",btnPrev:{label:"Отмена",onClick:()=>{alert("Пока нельзя :)")}},btnNext:{label:"Далее",onClick:o.handleSubmit(s),disabled:Object.keys(o.formState.errors).length>0},...o,children:t(_,{...o,children:u(te,{children:[t(p,{name:"firstName",required:n.required,pattern:n.onlyLetters.pattern,render:({value:r,onChange:a,error:l})=>t(m,{value:r,label:"Фамилия*",placeholder:"Васильев",error:l,onChange:a})}),t(p,{name:"lastName",required:n.required,pattern:n.onlyLetters.pattern,render:({value:r,onChange:a,error:l})=>t(m,{value:r,label:"Имя*",placeholder:"Иван",error:l,onChange:a})}),t(p,{name:"middleName",required:n.required,pattern:n.onlyLetters.pattern,render:({value:r,onChange:a,error:l})=>t(m,{value:r,label:"Отчество*",placeholder:"Сергеевич",error:l,onChange:a})}),t(ee,{}),t(p,{name:"citizenship",required:n.required,render:({value:r,onChange:a,error:l})=>t(E,{value:r,placeholder:"Россия",label:"Гражданство*",items:V,showSearch:!0,onChange:a,error:l})}),u(re,{children:[t(p,{name:"gender",required:n.required,render:({onChange:r,error:a})=>t(J,{defaultValue:e==null?void 0:e.gender,label:"Пол*",items:[{icon:t(D,{}),value:"М"},{icon:t(Z,{}),value:"Ж"}],error:a,onChange:r})}),t(p,{name:"birthday",required:n.required,render:({value:r,onChange:a,error:l})=>t(M,{value:r,label:"Дата рождения*",placeholder:"01.01.2000",error:l,onChange:a})})]}),t(p,{name:"birthPlace",required:n.required,render:({value:r,onChange:a,error:l})=>t(ae,{children:t(m,{value:r,placeholder:"Введите наименование региона и населенного пункта",label:"Место рождения (как указано в паспорте)*",error:l,onChange:a})})})]})})})};export{oe as default};
